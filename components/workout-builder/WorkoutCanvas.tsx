...
import { Workout, WorkoutSection } from "@/lib/types";
    ...
    <>
      <div className="bg-white rounded-lg shadow-md p-3 flex flex-col h-full">
        ...
        <div className="mb-3 pb-3 border-b space-y-2">
          <div>
            <label className="block text-xs font-medium mb-0.5">Workout Name</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-xs font-medium mb-0.5">Difficulty</label>
          ...
          <div>
            {showAddSection ? (
              <div className="p-2 bg-blue-50 border border-blue-200 rounded space-y-1.5">
                <div>
                  <label className="block text-xs font-medium mb-0.5">Section Name</label>
